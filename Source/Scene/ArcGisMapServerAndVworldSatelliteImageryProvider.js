...
define([
   ...
   * used, if available.
   *
   * @alias ArcGisMapServerAndVworldSatelliteImageryProvider
   * @constructor
   *
   ...
   * @param {Boolean} [options.enablePickFeatures=true] If true, {@link ArcGisMapServerAndVworldSatelliteImageryProvider#pickFeatures} will invoke
   *        the Identify service on the MapServer and return the features included in the response.  If false,
   *        {@link ArcGisMapServerAndVworldSatelliteImageryProvider#pickFeatures} will immediately return undefined (indicating no pickable features)
   *        without communicating with the server.  Set this property to false if you don't want this provider's features to
   *        be pickable. Can be overridden by setting the {@link ArcGisMapServerAndVworldSatelliteImageryProvider#enablePickFeatures} property on the object.
   ...
   *
   * @example
   * var esri = new Cesium.ArcGisMapServerAndVworldSatelliteImageryProvider({
   ...
   */
  function ArcGisMapServerAndVworldSatelliteImageryProvider(options) {
    ...
    /**
     * Gets or sets a value indicating whether feature picking is enabled.  If true, {@link ArcGisMapServerAndVworldSatelliteImageryProvider#pickFeatures} will
  ...
  function buildImageUrl(imageryProvider, x, y, level) {
    ...
    if (
      ...
      url = 'http://xdworld.vworld.kr:8080/2d/Satellite/201612/' + level + '/' + x + '/' + y + '.jpeg';
    }
  ...
  defineProperties(ArcGisMapServerAndVworldSatelliteImageryProvider.prototype, {
    /**
     * Gets the URL of the ArcGIS MapServer.
     * @memberof ArcGisMapServerAndVworldSatelliteImageryProvider.prototype
     * @type {String}
     * @readonly
     */
    url : {
     ...
     * not be called before {@link ArcGisMapServerAndVworldSatelliteImageryProvider#ready} returns true.
     * @memberof ArcGisMapServerAndVworldSatelliteImageryProvider.prototype
     * @type {Number}
     * @readonly
     */
     ...
     * the source of the imagery.  This function should not be called before {@link ArcGisMapServerAndVworldSatelliteImageryProvider#ready} returns true.
     * @memberof ArcGisMapServerAndVworldSatelliteImageryProvider.prototype
     * @type {Credit}
     * @readonly
     */
     ...
     * ArcGIS MapServer.  If the imagery provider is not yet ready ({@link ArcGisMapServerAndVworldSatelliteImageryProvider#ready}), this function
   ...
   */
  ArcGisMapServerAndVworldSatelliteImageryProvider.prototype.getTileCredits = function(x, y, level) {
    return undefined;
  };
   ...
   */
  ArcGisMapServerAndVworldSatelliteImageryProvider.prototype.requestImage = function(x, y, level) {
    //>>includeStart('debug', pragmas.debug);
    if (!this._ready) {
   ...
   */
  ArcGisMapServerAndVworldSatelliteImageryProvider.prototype.pickFeatures = function(x, y, level, longitude, latitude) {
    //>>includeStart('debug', pragmas.debug);
    if (!this._ready) {
  ...
  return ArcGisMapServerAndVworldSatelliteImageryProvider;
});
