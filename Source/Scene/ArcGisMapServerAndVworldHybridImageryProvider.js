...
define([
   ...
   * @param {Boolean} [options.enablePickFeatures=true] If true, {@link ArcGisMapServerAndVworldHybridImageryProvider#pickFeatures} will invoke
   *        the Identify service on the MapServer and return the features included in the response.  If false,
   *        {@link ArcGisMapServerAndVworldHybridImageryProvider#pickFeatures} will immediately return undefined (indicating no pickable features)
   *        without communicating with the server.  Set this property to false if you don't want this provider's features to
   *        be pickable. Can be overridden by setting the {@link ArcGisMapServerAndVworldHybridImageryProvider#enablePickFeatures} property on the object.
   ...
   */
  function ArcGisMapServerAndVworldHybridImageryProvider(options) {
    ...
    /**
     * Gets or sets a value indicating whether feature picking is enabled.  If true, {@link ArcGisMapServerAndVworldHybridImageryProvider#pickFeatures} will
   ...
   */
  ArcGisMapServerAndVworldHybridImageryProvider.prototype.pickFeatures = function(x, y, level, longitude, latitude) {
    //>>includeStart('debug', pragmas.debug);
    if (!this._ready) {
