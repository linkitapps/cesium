...
define([
   ...
   * used, if available.
   *
   * @alias ArcGisMapServerAndVworldBaseImageryProvider
   * @constructor
   *
   ...
   * @param {Boolean} [options.enablePickFeatures=true] If true, {@link ArcGisMapServerAndVworldBaseImageryProvider#pickFeatures} will invoke
   *        the Identify service on the MapServer and return the features included in the response.  If false,
   *        {@link ArcGisMapServerAndVworldBaseImageryProvider#pickFeatures} will immediately return undefined (indicating no pickable features)
   *        without communicating with the server.  Set this property to false if you don't want this provider's features to
   *        be pickable. Can be overridden by setting the {@link ArcGisMapServerAndVworldBaseImageryProvider#enablePickFeatures} property on the object.
   ...
   *
   * @example
   * var esri = new Cesium.ArcGisMapServerAndVworldBaseImageryProvider({
   ...
   */
  function ArcGisMapServerAndVworldBaseImageryProvider(options) {
    ...
    /**
     * Gets or sets a value indicating whether feature picking is enabled.  If true, {@link ArcGisMapServerAndVworldBaseImageryProvider#pickFeatures} will
  ...
  function buildImageUrl(imageryProvider, x, y, level) {
    ...
    if (
      ...
      url = 'http://xdworld.vworld.kr:8080/2d/Base/201612/' + level + '/' + x + '/' + y + '.png';
    }
  ...
  defineProperties(ArcGisMapServerAndVworldBaseImageryProvider.prototype, {
    /**
     * Gets the URL of the ArcGIS MapServer.
     * @memberof ArcGisMapServerAndVworldBaseImageryProvider.prototype
     * @type {String}
     * @readonly
     */
    url : {
     ...
     * not be called before {@link ArcGisMapServerAndVworldBaseImageryProvider#ready} returns true.
     * @memberof ArcGisMapServerAndVworldBaseImageryProvider.prototype
     * @type {Number}
     * @readonly
     */
     ...
     * the source of the imagery.  This function should not be called before {@link ArcGisMapServerAndVworldBaseImageryProvider#ready} returns true.
     * @memberof ArcGisMapServerAndVworldBaseImageryProvider.prototype
     * @type {Credit}
     * @readonly
     */
     ...
     * ArcGIS MapServer.  If the imagery provider is not yet ready ({@link ArcGisMapServerAndVworldBaseImageryProvider#ready}), this function
   ...
   */
  ArcGisMapServerAndVworldBaseImageryProvider.prototype.getTileCredits = function(x, y, level) {
    return undefined;
  };
   ...
   */
  ArcGisMapServerAndVworldBaseImageryProvider.prototype.requestImage = function(x, y, level) {
    //>>includeStart('debug', pragmas.debug);
    if (!this._ready) {
   ...
   */
  ArcGisMapServerAndVworldBaseImageryProvider.prototype.pickFeatures = function(x, y, level, longitude, latitude) {
    //>>includeStart('debug', pragmas.debug);
    if (!this._ready) {
  ...
  return ArcGisMapServerAndVworldBaseImageryProvider;
});
